...
class Settings:
    ...
    x_platform: str = _setting("MODETOUR_X_PLATFORM", "WEB")
    x_salespartner: str = _setting("MODETOUR_X_SALESPARTNER", "false")
    x_username: str = _setting("MODETOUR_X_USERNAME")
    x_userid: str = _setting("MODETOUR_X_USERID", "0")
    x_userdepartment: str = _setting("MODETOUR_X_USERDEPARTMENT")
